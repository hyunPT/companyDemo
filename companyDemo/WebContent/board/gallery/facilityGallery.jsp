				...
				<div id="myTabHolder" class="span10 offset1 tabbable tabs-left">
					<ul class="nav">
						<li class="active"><a href="#lA" data-toggle="tab"> <span
								class="account-type">시설사진</span><br /></a></li>
					</ul>
												...
												<div class="tz-gallery">
													<div class="row">
														<div class="col-sm-6 col-md-4">
															<div class="thumbnail">
																<a class="lightbox"
																	href="../../resources/images/restarea.jpg"> <img
																	src="../../resources/images/restarea.jpg" alt="Park">
																</a>
																<div class="caption">
																	<h3>휴게실</h3>
																	<p>휴게실 설명</p>
														...
														<div class="col-sm-6 col-md-4">
															<div class="thumbnail">
																<a class="lightbox"
																	href="../../resources/images/Cafeteras.jpg"> <img
																	src="../../resources/images/Cafeteras.jpg" alt="Bridge">
																</a>
																<div class="caption">
																	<h3>카페테라스</h3>
																	<p>카페테라스 설명</p>
														...
														<div class="col-sm-6 col-md-4">
															<div class="thumbnail">
																<a class="lightbox"
																	href="../../resources/images/mettingroom.jpg"> <img
																	src="../../resources/images/mettingroom.jpg"
																	alt="Tunnel">
																</a>
																<div class="caption">
																	<h3>회의실</h3>
														...
														<div class="col-sm-6 col-md-4">
															<div class="thumbnail">
																<a class="lightbox"
																	href="../../resources/images/office.jpg"> <img
																	src="../../resources/images/office.jpg" alt="Coast">
																</a>
																<div class="caption">
																	<h3>사무실</h3>
																	<p>사무실 설명</p>
														...
														<div class="col-sm-6 col-md-4">
															<div class="thumbnail">
																<a class="lightbox"
																	href="../../resources/images/showerroom.jpg"> <img
																	src="../../resources/images/showerroom.jpg" alt="Rails">
																</a>
																<div class="caption">
																	<h3>샤워실</h3>
																	<p>샤워실 설명</p>
